...
(function (window) {
        ...
        function getListeners(obj, event) {
          var events = obj._getEvents();
          var response = [];
      
          if (typeof event === 'object') {
            for (var key in events) {
              if (events.hasOwnProperty(key) && event.test(key)) {
                response.push(events[key]);
              }
            }
          } else {
            response.push(events[event] || (events[event] = []));
          }
        ...
        function getListenersAsObject(obj, event) {
          var listeners = getListeners(obj, event);
          var response = {};
        ...
        function addOnceListener(obj, event, listener) {
          return addListener(obj, event, { listener: listener, once: true });
        }
      
        function defineEvent(obj, event) {
          getListeners(obj, event);
          return obj;
        }
      
        function defineEvents(obj, events) {
          for (var i = 0; i < events.length; i += 1) {
            defineEvent(obj, events[i]);
          }
          return obj;
        }
        ...
        function removeEvent(obj, event) {
          var events = typeof event === 'object' ? Object.keys(obj._getEvents()) : [event];
      
          for (var i = 0; i < events.length; i += 1) {
            var eventName = events[i];
            delete obj._events[eventName];
          }
        ...
        function removeAllListeners(obj) {
          for (var key in obj._events) {
            if (obj._events.hasOwnProperty(key)) {
              delete obj._events[key];
            }
          }
        ...
        function emitEvent(obj, event, args) {
          var listeners = getListenersAsObject(obj, event);
          var listener;
          var i;
          var key;
          var response;
            ...
            if (listeners.hasOwnProperty(key)) {
              ...
              while (i--) {
                ...
                if (listener.once === true) {
                  removeListener(obj, event, listener.listener);
                }
      
                response = listener.listener.apply(obj, args || []);
      
                if (response === obj._getOnceReturnValue()) {
                  removeListener(obj, event, listener.listener);
                }
              }
            }
        ...
        function noConflict() {
          return (window.EventEmitter = EventEmitter);
        }
        ...
        EventEmitter.prototype = {
          ...
          flattenListeners: function (event) {
            return flattenListeners(getListeners(this, event));
          },
          getListenersAsObject: function (event) {
            return getListenersAsObject(this, event);
          },
          addListener: function (event, listener) {
            return addListener(this, event, listener);
          },
          on: function (event, listener) {
            return this.addListener(event, listener);
          },
          addOnceListener: function (event, listener) {
            return addOnceListener(this, event, listener);
          },
          once: function (event, listener) {
            return this.addOnceListener(event, listener);
          },
          defineEvent: function (event) {
            return defineEvent(this, event);
          },
          defineEvents: function (events) {
            return defineEvents(this, events);
          },
          removeListener: function (event, listener) {
            return removeListener(this, event, listener);
          },
          off: function (event, listener) {
            return this.removeListener(event, listener);
          },
          addListeners: function (event, listeners) {
            return this.manipulateListeners(false, event, listeners);
          },
          removeListeners: function (event, listeners) {
            return this.manipulateListeners(true, event, listeners);
          },
          manipulateListeners: function (remove, event, listeners) {
            var i;
            var value;
            ...
            if (typeof event === 'object' && !(event instanceof RegExp)) {
              for (i in event) {
                if (event.hasOwnProperty(i) && (value = event[i])) {
          ...
          _getOnceReturnValue: getOnceReturnValue,
        ...
        function eventie(eventEmitter, eventie) {
          return eventie(eventEmitter, eventie);
        }
      
        if (typeof define === 'function' && define.amd) {
          define('eventie/eventie', ['eventEmitter/EventEmitter'], function (EventEmitter) {
            return eventie(EventEmitter);
          });
        ...
        function imagesLoaded(window, EventEmitter, eventie) {
          ...
          ImagesLoaded.prototype.complete = function () {
            ...
            setTimeout(function () {
              _this.emitEvent(eventName, [_this]);
              _this.emitEvent('always', [_this]);
              if (_this.jqDeferred) {
          ...
          Image.prototype.check = function () {
            ...
            this.img.addEventListener('load', function () {
              _this.confirm(true, 'load');
            });
      
            this.img.addEventListener('error', function () {
              _this.confirm(false, 'error');
            });
          };
      
          Image.prototype.confirm = function (isLoaded, message) {
            this.isConfirmed = true;
            this.isLoaded = isLoaded;
            this.emitEvent('confirm', [this, message]);
          };
        ...
        if (typeof define === 'function' && define.amd) {
          define('imagesLoaded/imagesLoaded', ['eventEmitter/EventEmitter', 'eventie/eventie'], function (EventEmitter, eventie) {
            return imagesLoaded(window, EventEmitter, eventie);
          });
        } else if (typeof exports === 'object') {
          module.exports = imagesLoaded(window, require('wolfy87-eventemitter'), require('eventie'));
        } else {
          window.imagesLoaded = imagesLoaded(window, window.EventEmitter, window.eventie);
        }
      })(window);
